...
const Subcategory_1 = require("../../domain/entities/Subcategory");
class SubcategoriesRepository {
    constructor(dataSource) {
        this._baseRepository = dataSource.getRepository(Subcategory_1.Subcategory);
    }
    insert(entity) {
    ...
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._baseRepository.find({ order: { description: "ASC" } });
        });
    }
    getByCategoryId(categoryId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._baseRepository.find({ where: { category_id: categoryId }, order: { description: "ASC" } });
        });
    }
}
