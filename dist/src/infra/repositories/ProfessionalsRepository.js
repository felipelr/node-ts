...
exports.ProfessionalsRepository = void 0;
const Professional_1 = require("../../domain/entities/Professional");
class ProfessionalsRepository {
    constructor(dataSource) {
        this._baseRepository = dataSource.getRepository(Professional_1.Professional);
    }
    getByUserId(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._baseRepository.findOneBy({ user_id: userId });
        });
    }
    insert(entity) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.ProfessionalsRepository = ProfessionalsRepository;
